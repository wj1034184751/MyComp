namespace YuanTu.Platform.St
{
    ...
    /// </summary>
    public class DigitalMap : CustomEntityWithOrg<string>
    {
        ...
        /// 每单位尺寸
        /// </summary>
        [Column("PerScale", TypeName = "decimal(0, 0)")]
        ...
        /// </summary>
        [Required()]
        [Column("MaxDepth", TypeName = "decimal(0, 0)")]
        ...
        /// </summary>
        [Required()]
        [Column("MinDepth", TypeName = "decimal(0, 0)")]
