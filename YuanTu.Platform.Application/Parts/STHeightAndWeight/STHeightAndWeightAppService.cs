...
{
    [AbpAuthorize]
    public class STHeightAndWeightAppService : AsynPermissionAppService<STHeightAndWeight, STHeightAndWeightDto, string, PagedSTHeightAndWeightRequestDto, STHeightAndWeightDto, STHeightAndWeightDto>, ISTHeightAndWeightAppService
    {
        private readonly IRepository<AbpAttachment, string> _repositoryAttachment;
        public STHeightAndWeightAppService(IRepository<STHeightAndWeight, string> repository, IRepository<AbpAttachment, string> repositoryAttachment) : base(repository)
        {
            _repositoryAttachment = repositoryAttachment;
        }

        protected override IQueryable<STHeightAndWeight> CreateFilteredQuery(PagedSTHeightAndWeightRequestDto input)
        {
        ...
        [ActionName("GetPage")]
        public override async Task<PagedResultDto<STHeightAndWeightDto>> GetAllAsync(PagedSTHeightAndWeightRequestDto input)
        {
        ...
        public override async Task<STHeightAndWeightDto> CreateAsync(STHeightAndWeightDto input)
        {
            try
            {
                var model = ObjectMapper.Map<STHeightAndWeight>(input);
        ...
        public override async Task<STHeightAndWeightDto> UpdateAsync(STHeightAndWeightDto input)
        {
            try
            {
