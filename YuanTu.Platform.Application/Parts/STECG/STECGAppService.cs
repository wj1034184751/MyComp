...
{
    [AbpAuthorize]
    public class STECGAppService : AsynPermissionAppService<STECG, STECGDto, string, PagedSTECGRequestDto, STECGDto, STECGDto>, ISTECGAppService
    {
        private readonly IRepository<AbpAttachment, string> _repositoryAttachment;
        public STECGAppService(IRepository<STECG, string> repository, IRepository<AbpAttachment, string> repositoryAttachment) : base(repository)
        {
            _repositoryAttachment = repositoryAttachment;
        }

        protected override IQueryable<STECG> CreateFilteredQuery(PagedSTECGRequestDto input)
        {
        ...
        [ActionName("GetPage")]
        public override async Task<PagedResultDto<STECGDto>> GetAllAsync(PagedSTECGRequestDto input)
        {
        ...
        public override async Task<STECGDto> CreateAsync(STECGDto input)
        {
            try
            {
                var model = ObjectMapper.Map<STECG>(input);
        ...
        public override async Task<STECGDto> UpdateAsync(STECGDto input)
        {
            try
            {
