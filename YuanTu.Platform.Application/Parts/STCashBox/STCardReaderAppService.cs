...
{
    [AbpAuthorize]
    public class STCashBoxAppService : AsynPermissionAppService<STCashBox, STCashBoxDto, string, PagedSTCashBoxRequestDto, STCashBoxDto, STCashBoxDto>, ISTCashBoxAppService
    {
        private readonly IRepository<AbpAttachment, string> _repositoryAttachment;
        public STCashBoxAppService(IRepository<STCashBox, string> repository, IRepository<AbpAttachment, string> repositoryAttachment) : base(repository)
        {
            _repositoryAttachment = repositoryAttachment;
        }

        protected override IQueryable<STCashBox> CreateFilteredQuery(PagedSTCashBoxRequestDto input)
        {
        ...
        [ActionName("GetPage")]
        public override async Task<PagedResultDto<STCashBoxDto>> GetAllAsync(PagedSTCashBoxRequestDto input)
        {
        ...
        public override async Task<STCashBoxDto> CreateAsync(STCashBoxDto input)
        {
            try
            {
                var model = ObjectMapper.Map<STCashBox>(input);
        ...
        public override async Task<STCashBoxDto> UpdateAsync(STCashBoxDto input)
        {
            try
            {
