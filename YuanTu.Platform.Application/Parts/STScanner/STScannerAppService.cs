...
{
    [AbpAuthorize]
    public class STScannerAppService : AsynPermissionAppService<STScanner, STScannerDto, string, PagedSTScannerRequestDto, STScannerDto, STScannerDto>, ISTScannerAppService
    {
        private readonly IRepository<AbpAttachment, string> _repositoryAttachment;
        public STScannerAppService(IRepository<STScanner, string> repository, IRepository<AbpAttachment, string> repositoryAttachment) : base(repository)
        {
            _repositoryAttachment = repositoryAttachment;
        }

        protected override IQueryable<STScanner> CreateFilteredQuery(PagedSTScannerRequestDto input)
        {
        ...
        [ActionName("GetPage")]
        public override async Task<PagedResultDto<STScannerDto>> GetAllAsync(PagedSTScannerRequestDto input)
        {
        ...
        public override async Task<STScannerDto> CreateAsync(STScannerDto input)
        {
            try
            {
                var model = ObjectMapper.Map<STScanner>(input);
        ...
        public override async Task<STScannerDto> UpdateAsync(STScannerDto input)
        {
            try
            {
