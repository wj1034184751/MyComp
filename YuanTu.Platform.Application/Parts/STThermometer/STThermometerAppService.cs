...
{
    [AbpAuthorize]
    public class STThermometerAppService : AsynPermissionAppService<STThermometer, STThermometerDto, string, PagedSTThermometerRequestDto, STThermometerDto, STThermometerDto>, ISTThermometerAppService
    {
        private readonly IRepository<AbpAttachment, string> _repositoryAttachment;
        public STThermometerAppService(IRepository<STThermometer, string> repository, IRepository<AbpAttachment, string> repositoryAttachment) : base(repository)
        {
            _repositoryAttachment = repositoryAttachment;
        }

        protected override IQueryable<STThermometer> CreateFilteredQuery(PagedSTThermometerRequestDto input)
        {
        ...
        [ActionName("GetPage")]
        public override async Task<PagedResultDto<STThermometerDto>> GetAllAsync(PagedSTThermometerRequestDto input)
        {
        ...
        public override async Task<STThermometerDto> CreateAsync(STThermometerDto input)
        {
            try
            {
                var model = ObjectMapper.Map<STThermometer>(input);
        ...
        public override async Task<STThermometerDto> UpdateAsync(STThermometerDto input)
        {
            try
            {
