...
{
    [AbpAuthorize]
    public class STSphygmomanometerAppService : AsynPermissionAppService<STSphygmomanometer, STSphygmomanometerDto, string, PagedSTSphygmomanometerRequestDto, STSphygmomanometerDto, STSphygmomanometerDto>, ISTSphygmomanometerAppService
    {
        private readonly IRepository<AbpAttachment, string> _repositoryAttachment;
        public STSphygmomanometerAppService(IRepository<STSphygmomanometer, string> repository, IRepository<AbpAttachment, string> repositoryAttachment) : base(repository)
        {
            _repositoryAttachment = repositoryAttachment;
        }

        protected override IQueryable<STSphygmomanometer> CreateFilteredQuery(PagedSTSphygmomanometerRequestDto input)
        {
        ...
        [ActionName("GetPage")]
        public override async Task<PagedResultDto<STSphygmomanometerDto>> GetAllAsync(PagedSTSphygmomanometerRequestDto input)
        {
        ...
        public override async Task<STSphygmomanometerDto> CreateAsync(STSphygmomanometerDto input)
        {
            try
            {
                var model = ObjectMapper.Map<STSphygmomanometer>(input);
        ...
        public override async Task<STSphygmomanometerDto> UpdateAsync(STSphygmomanometerDto input)
        {
            try
            {
