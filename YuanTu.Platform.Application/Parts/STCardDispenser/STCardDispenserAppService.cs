...
{
    [AbpAuthorize]
    public class STCardDispenserAppService : AsynPermissionAppService<STCardDispenser, STCardDispenserDto, string, PagedSTCardDispenserRequestDto, STCardDispenserDto, STCardDispenserDto>, ISTCardDispenserAppService
    {
        private readonly IRepository<AbpAttachment, string> _repositoryAttachment;
        public STCardDispenserAppService(IRepository<STCardDispenser, string> repository, IRepository<AbpAttachment, string> repositoryAttachment) : base(repository)
        {
            _repositoryAttachment = repositoryAttachment;
        }

        protected override IQueryable<STCardDispenser> CreateFilteredQuery(PagedSTCardDispenserRequestDto input)
        {
        ...
        [ActionName("GetPage")]
        public override async Task<PagedResultDto<STCardDispenserDto>> GetAllAsync(PagedSTCardDispenserRequestDto input)
        {
        ...
        public override async Task<STCardDispenserDto> CreateAsync(STCardDispenserDto input)
        {
            try
            {
                var model = ObjectMapper.Map<STCardDispenser>(input);
        ...
        public override async Task<STCardDispenserDto> UpdateAsync(STCardDispenserDto input)
        {
            try
            {
