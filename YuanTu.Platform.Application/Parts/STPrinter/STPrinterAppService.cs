...
{
    [AbpAuthorize]
    public class STPrinterAppService : AsynPermissionAppService<STPrinter, STPrinterDto, string, PagedSTPrinterRequestDto, STPrinterDto, STPrinterDto>, ISTPrinterAppService
    {
        private readonly IRepository<AbpAttachment, string> _repositoryAttachment;
        public STPrinterAppService(IRepository<STPrinter, string> repository, IRepository<AbpAttachment, string> repositoryAttachment) : base(repository)
        {
            _repositoryAttachment = repositoryAttachment;
        }

        protected override IQueryable<STPrinter> CreateFilteredQuery(PagedSTPrinterRequestDto input)
        {
        ...
        [ActionName("GetPage")]
        public override async Task<PagedResultDto<STPrinterDto>> GetAllAsync(PagedSTPrinterRequestDto input)
        {
        ...
        public override async Task<STPrinterDto> CreateAsync(STPrinterDto input)
        {
            try
            {
                var model = ObjectMapper.Map<STPrinter>(input);
        ...
        public override async Task<STPrinterDto> UpdateAsync(STPrinterDto input)
        {
            try
            {
